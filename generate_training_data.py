...
def generate_graph_seq2seq_io_data(
        data, x_offsets, y_offsets, add_time_in_day=True, add_day_in_week=False, scaler=None
):
    """
...
if __name__ == "__main__":
    ...
    parser.add_argument("--traffic_df_filename", type=str, default="/gpu-data/hsj/dynamic_datasets/PEMS08/PEMS08.npz", help="Raw traffic readings.",)
